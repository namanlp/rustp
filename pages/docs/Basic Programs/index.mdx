...
order: 1
slug: /basic-programs/
description: In Competitive Programming, it is generally the very first step to take a number as input. We will design a function that takes input and returns a number in any desired numerical data type, and also make Simple Multiplication Program.
---
...
In Competitive Programming, it is generally the very first step to take a number as input **and store it as a number** for multiple operations, like addition, subtraction, multiplication, division etc.
...
**Note :** In this program, we will assume that **integers are in different lines** and only 1 integer per line is allowed.

## Simple Multiplication Program

So, let's start with designing a multiplication program. In this program, we will take two integers and output the result of their multiplication.
...
You can replace usize with any numerical data type you want.
