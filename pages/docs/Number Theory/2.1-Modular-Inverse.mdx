...
<GatsbySeo
    description=
        "Modular Multiplicative Inverse is a number that replaces the divide function in Modular Arithmetic. We will make a function to find Modular Multiplicative Inverse of a number in Rust, and optimize it to logarithmic time complexity using Fermat's little theorem."
    openGraph={{
        description:
            "Modular Multiplicative Inverse is a number that replaces the divide function in Modular Arithmetic. We will make a function to find Modular Multiplicative Inverse of a number in Rust, and optimize it to logarithmic time complexity using Fermat's little theorem.",
    }}
