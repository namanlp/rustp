...
We can easily use it in the code, any way we like, for example for calculating ¹⁰⁰ C ₅₁, we have to just write,

`factorial_array[100] / (factorial_array[49] * factorial_array[51])`
...
Reading these articles, you now know much about factorials and how to efficiently code factorial programs.
