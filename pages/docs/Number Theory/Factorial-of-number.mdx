...
description: Factorial is an important property of a number. It is used a lot of times, especially for calculating Permutation and Combination, Probability etc. for a given set of numbers.
---
