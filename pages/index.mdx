...
<FeatureSection>
    <FeatureList>
        ...
        <Feature className="feature-item">
            ...
            <FeatureText className="feature-text">
                Rust is an Open Source Project supported by Mozilla Research. Its source code can by found at <a href="https://github.com/rust-lang" target="_blank">Rust's Github Repo </a>
            </FeatureText>
        </Feature>
        <Feature className="feature-item">
