...
<FeatureSection>
    <FeatureList>
        ...
        <Feature className="feature-item">
            <img className="feature-image" src={motherBoard} load = "lazy" alt="Low Level Programming Support" />
...
<SEO description="Providing Guides and ready to use codes in Rust Language for development as well as competitive programming. Rust is fast, memory efficient, memory safe, uses borrow checker, provide Low Level Programming support and is lot more interesting." />
