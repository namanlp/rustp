  ...
  plugins: [
    {
      ...
      options: {
        ...
        author: "Naman Garg",
        sections: ['1. Basic Programs', '2. Number Theory', '2.1 Arithmetic Operations', '2.2 Factors of a Number', '3 Combinatorics', '4 Data Structures', '5.1 Array Algorithms', '5.2 Dynamic Programming', 'X.1 Codeforces Solutions'],
