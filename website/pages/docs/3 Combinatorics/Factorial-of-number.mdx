...
order: 1
slug: /combinatorics/factorial-of-number/
...
**40! = 8.15×10<sup>47</sup> , which is so large that no numerical data structure in rust can store this value.**
...
**Note :** We will take maximum the most optimized, that is `usize` data type in this article.
...
pub fn main() {
    // Read and parse number to usize
...
fn factorial(number : usize) -> usize{
    ...
    // initialize factorial to 1, explicitly type usize
...
<SEO title="Factorial Of a Number - Rust Programming"
     description="Factorial is an important value of a number. This article covers the basic definition factorial, properties and simple functions to find factorial of a number in Rust in both Iterative and Recursive manner" />
