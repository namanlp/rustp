...
**Note:** Although the time complexity is higher in this approach, it will be very less for higher number of queries. For example, if we have n queries of  <sup>n</sup>P<sub>r</sub>, the time taken by this approach will still be O( log(n) ),
