...
2. **When repetition is not allowed :** If Repetition of an object is not allowed, then permutations can be written as  **<sup>n</sup>P<sub>r</sub> = n! / r!** We can calculate it using [Factorial function](combinatorics/factorial-of-number/)
