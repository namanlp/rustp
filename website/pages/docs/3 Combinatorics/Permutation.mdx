...
So, total number of ways of arranging *n* items taking *r* at a time is written **<sup>n</sup>P<sub>r</sub>**. It will also be written as **P(n, r)**

## Permutation for all Distinct objects

1. **When repetition is allowed :** If Repetition of an object is allowed, then we can simply write number of permutations = **n<sup>r</sup>**
2. **When repetition is not allowed :** If Repetition of an object is not allowed, then permutations can be written as  **<sup>n</sup>P<sub>r</sub> = n! / r!**
