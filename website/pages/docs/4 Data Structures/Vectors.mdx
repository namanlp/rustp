...
description: Vectors are array like contiguous and growable storage with a lot more functionalities. We will see vectors and the built-in methods for creating a vector, insertion, accessing and removing an element  in Rust.
---
