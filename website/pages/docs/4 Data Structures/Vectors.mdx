...
**Note :** Capacity is not fixed, that is, if you insert more elements than initially declared capacity, it will reallocate the space and copy the vector elements to the new location.
