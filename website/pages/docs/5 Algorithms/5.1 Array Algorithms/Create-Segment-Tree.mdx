...
description: Segment tree is used frequently for processing Range Queries in logarithmic time complexity. In this article, we will learn about Segment Tree, and also write a function to construct a Segment Tree in Rust Language.
---
...
In this article, we saw the code to construct a Segment Tree in Rust. We will see Range Queries in the next article.

**Thank You**

import {SEO} from "smooth-doc/src/components/SEO";

<SEO title="Creating a Segment Tree - Rust Programming"
     description="Segment tree is used frequently for processing Range Queries in logarithmic time complexity. In this article, we will learn about Segment Tree, and also write a function to construct a Segment Tree in Rust Language."
     />
