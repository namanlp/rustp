...
The Segment Tree is a commonly used tree like data structure that is used for **range queries**, like minimum element or sum of elements in a given subarray.
