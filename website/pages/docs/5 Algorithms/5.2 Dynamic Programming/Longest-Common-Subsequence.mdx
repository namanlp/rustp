...
fn longest_common_subsequence(string1:&Vec<char>, string2:&Vec<char>, n:usize, m:usize) -> usize {
    ...
    return max( longest_common_subsequence(string1, string2, n-1, m), longest_common_subsequence(string1, string2, n, m-1));
}
```
...
fn main() {
    ...
    println!("Length of longest common subsequence is : {}", longest_common_subsequence(&string1, &string2, string1.len(), string2.len()));
}
```
...
( Space complexity include recursive stack space )
