...
3. We have to check only odd multiples of  numbers ( except 2 ), because even multiples are already marked false by 2.

These optimizations can make Sieve method generally **faster by more than 50%** , though it do not affect the time complexity of the code.
