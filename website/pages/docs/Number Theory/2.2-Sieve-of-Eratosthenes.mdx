...
import sieve3 from "../../../images/Number Theory/sieve/sieve-3.webp"

<div style={{textAlign: 'center'}} >
    <img src={sieve3} width="100%" alt="Mark multiples of 3 as false" />
</div>
...
<div style={{textAlign: 'center'}} >
    <img src={sieve4} width="100%" alt="Mark multiples of 5 as false" />
</div>